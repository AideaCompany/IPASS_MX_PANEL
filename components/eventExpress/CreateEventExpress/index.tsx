  ...
  return (
    <>
      <RealTimeVerification
        ...
        deleteContact={deleteActualContact}
        registro={registro}
        setVisible={setVisibleVideo}
        actualContact={selectedContact[0] as string}
        eventExpress={eventExpressData}
      />
              ...
              <>
                <div className="formContainer">
                  ...
                  <div style={{ marginTop: '5px' }}>
                    <h2>Añadir a Evento Express</h2>
                    <p>
                      <i>Si desea añadir el contacto a un evento express diligencie los datos del siguiente formulario:</i>
                    </p>
